...
{
	std::cout << "HARL: I love having extra bacon for my 7XL-double-cheese-triple-pickle-specialketchup burger. I really do!"
				<< std::endl;
}
...
void	Harl::complain(std::string level)
{
	...
	void (Harl::*ptr_fun[4])(void) = {&Harl::debug, &Harl::info, &Harl::warning, &Harl::error};
